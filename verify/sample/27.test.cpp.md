...
data:
  ...
  bundledCode: "#line 1 \"verify/sample/27.test.cpp\"\n/*\n * @uni_kakurenbo\n * https://github.com/uni-kakurenbo/competitive-programming-workspace\n\
  ...
  verifiedWith: []
documentation_of: verify/sample/27.test.cpp
layout: document
redirect_from:
- /verify/verify/sample/27.test.cpp
- /verify/verify/sample/27.test.cpp.html
